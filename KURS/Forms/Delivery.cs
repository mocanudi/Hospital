...
namespace KURS.Forms
{
    public partial class Delivery : Form
    {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView1.Columns.Add("librarian_FIO", "ФИО врача");
            dataGridView1.Columns.Add("librarian_Phone", "Телефон врача");
            dataGridView1.Columns.Add("librarian_position", "Должность врача");
            dataGridView1.Columns.Add("librarian_specialization", "Специализация врача");
            dataGridView1.Columns.Add("librarian_qualification", "Квалификация врача");
