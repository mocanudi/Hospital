...
namespace KURS.Forms
{
    public partial class Orders : Form
    {
        ...
        {
            dataGridView1.Columns.Add("ID_borrowing", "ID приема");//0
            dataGridView1.Columns.Add("borrowing_DateOfObrashenia", "Дата обращения");//1
            //dataGridView1.Columns.Add("borrowing_DateOfReturn", "Дата возвращения");//2
            dataGridView1.Columns.Add("borrowing_price", "Стоимость приема");//2
            dataGridView1.Columns.Add("borrowing_Status", "Статус обращения");//3
            dataGridView1.Columns.Add("ID_librarian", "ID врача");//4
            dataGridView1.Columns.Add("ID_book", "ID диагноза");//5
            dataGridView1.Columns.Add("ID_reader", "ID пациента");//6
            dataGridView1.Columns.Add("reader_Surname", "Фамилия пациента");//7
            dataGridView1.Columns.Add("librarian_FIO", "ФИО врача");//8
            dataGridView1.Columns.Add("book_Name", "Название диагноза");//9
            dataGridView1.Columns.Add("isNew", String.Empty);
        }
        private void ReadSingleRow(DataGridView dwg, IDataRecord record)
        {
            dwg.Rows.Add(record.GetInt32(0),
                 record.GetDateTime(1), record.GetInt32(2),
                 record.GetString(3), record.GetInt32(4),

                 record.GetInt32(5), record.GetInt32(6),
                 record.GetString(7), record.GetString(8),
                 record.GetString(9),
