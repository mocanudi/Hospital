...
namespace KURS.Forms.Zaprosi
{
    public partial class Z1 : Form
    {
        ...
        {
            dataGridView1.Columns.Add("ID_borrowing", "ID приема");//3
            dataGridView1.Columns.Add("ID_librarian", "ID врача");//
        ...
        private void ReadSingleRow(DataGridView dwg, IDataRecord record)
        {
            ...
            int ID_librarian = (record.GetValue(6) == DBNull.Value) ? 0 : (int)record.GetValue(6);
            string reader_Surname = (record.GetValue(14) == DBNull.Value) ? string.Empty : record.GetString(14);
            string book_Name = (record.GetValue(23) == DBNull.Value) ? string.Empty : record.GetString(23);
