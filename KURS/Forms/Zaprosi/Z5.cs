...
namespace KURS.Forms.Zaprosi
{
    public partial class Z5 : Form
    {
        ...
        private void ReadSingleRow(DataGridView dwg, IDataRecord record)
        {
            ...
            string clientAdress_Region = (record.GetValue(17) == DBNull.Value) ? string.Empty : record.GetString(17);
            string clientAdress_City = (record.GetValue(18) == DBNull.Value) ? string.Empty : record.GetString(18);
            string clientAdress_District = (record.GetValue(19) == DBNull.Value) ? string.Empty : record.GetString(19);
            string clientAdress_Street = (record.GetValue(20) == DBNull.Value) ? string.Empty : record.GetString(20);
            string clientAdress_House = (record.GetValue(21) == DBNull.Value) ? string.Empty : record.GetString(21);
            string clientAdress_Appartment = (record.GetValue(22) == DBNull.Value) ? string.Empty : record.GetString(22);
            string item_Name = (record.GetValue(24) == DBNull.Value) ? string.Empty : record.GetString(24);
        ...
        private void RefreshDataGrid1(DataGridView dwg, string city)
        {
            ...
            string querystring = $"SELECT * FROM Borrowing LEFT JOIN Reader ON Reader.ID_reader = Borrowing.ID_reader " +
        ...
        {
            dataGridView1.Columns.Add("client_Surname", "Фамилия пациента");
            dataGridView1.Columns.Add("item_Name", "Название диагноза");
            dataGridView1.Columns.Add("ID_order", "ID приема");
