...
namespace KURS.Forms
{
    public partial class NewAuthor : Form
    {
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand taskInsertCar = new SqlCommand("insert into Author (author_pills, author_sroklechenia)" +
                " values (@a, @b)", con);
            ...
            MessageBox.Show("Лечение добавлено!", "Успех!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            con.Close();
