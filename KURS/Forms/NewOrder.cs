    ...
    public partial class NewOrder : Form
    {
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=DIN;Initial Catalog=db_AK;Integrated Security=True");
                ...
                con.Open();
                SqlCommand taskInsertOrder = new SqlCommand("Insert into Borrowing(borrowing_DateOfObrashenia, borrowing_price, borrowing_Status, ID_book, ID_reader, ID_librarian) Values(@a, @b, @d, @e, @f, @g)", con);
                ...
                taskInsertOrder.Parameters["@b"].Value = textBox1.Text; 
                taskInsertOrder.Parameters["@d"].Value = textBox2.Text; 
                ...
                MessageBox.Show("Прием добавлен!", "Успех!", MessageBoxButtons.OK, MessageBoxIcon.Information);
