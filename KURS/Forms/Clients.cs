...
namespace KURS.Forms
{
    public partial class Clients : Form
    {
        ...
        private void CreateColumns()
        {
            ...
            dataGridView1.Columns.Add("reader_strahpolis", "Страховой полис");//5
            dataGridView1.Columns.Add("reader_medbook", "Медицинская книжка");//6
            dataGridView1.Columns.Add("reader_birthday", "День рождения");//7


            dataGridView1.Columns.Add("ID_AdressOfClient", "ID Адреса");//8
            dataGridView1.Columns.Add("ID_AdressOfClient", "ID Адреса");//9
            dataGridView1.Columns.Add("clientAdress_Region", "Регион");//10
            dataGridView1.Columns.Add("clientAdress_City", "Город");//11
            dataGridView1.Columns.Add("clientAdress_District", "Район");//12
            dataGridView1.Columns.Add("clientAdress_Street", "Улица");//13
            dataGridView1.Columns.Add("clientAdress_House", "Дом");//14
            dataGridView1.Columns.Add("clientAdress_Appartment", "Квартира");//15
            ...
            for (int index = 0; index < dataGridView1.Rows.Count; index++)
            {
                ...
                if (rowState == RowState.Modified)
                {
                    ...
                    var changeQuerry21 = $"update Reader set reader_Name = '{name}', reader_Surname = '{surname}', reader_Otchestvo = '{otch}', " +
                        $"reader_Phone = '{tel}', where ID_reader = '{id}'";
