...
namespace KURS.Forms
{
    public partial class NewClient : Form
    {
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand taskInsertCar = new SqlCommand("Insert into Reader(reader_Name, reader_Surname, reader_Otchestvo, reader_Phone, reader_strahpolis, reader_medbook, reader_birthday, ID_AdressOfClient) Values(@a, @b, @c, @d, @e, @f, @g, @h)", con);
            ...
            taskInsertCar.Parameters.Add("@g", SqlDbType.VarChar);
            taskInsertCar.Parameters.Add("@h", SqlDbType.Int);
            ...
            taskInsertCar.Parameters["@f"].Value = textBox13.Text;
            taskInsertCar.Parameters["@g"].Value = textBox12.Text;

            taskInsertCar.Parameters["@h"].Value = id;
            taskInsertCar.ExecuteNonQuery();

            MessageBox.Show("Пациент добавлен!", "Успех!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            con.Close();
